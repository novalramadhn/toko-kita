...
<script src="{{ asset('AdminLTE-3.2.0/plugins/bootstrap/js/bootstrap.bundle.min.js.map') }}"></script>
<!-- ChartJS -->
...
<script src="{{ asset('AdminLTE-3.2.0/plugins/jqvmap/maps/jquery.vmap.usa.counties.js') }}"></script>
<script src="{{ asset('AdminLTE-3.2.0/plugins/jqvmap/maps/jquery.vmap.usa.districts.js') }}"></script>
<!-- jQuery Knob Chart -->
...
<script src="{{ asset('AdminLTE-3.2.0/plugins/summernote/summernote-bs4.min.js.LICENSE.txt') }}"></script>
<script src="{{ asset('AdminLTE-3.2.0/plugins/summernote/summernote-bs4.min.js.map') }}"></script>
<!-- overlayScrollbars -->
