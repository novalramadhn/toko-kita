    ...
    <div class="col col-lg-4 col-md-4">
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          ...
          <h3 class="profile-username text-center">Noval Ramadhan</h3>
          <p class="text-muted text-center">Member sejak : 22 Nov 2001</p>
          <hr>
          <strong>
          ...
          <hr>
          <a href="{{ URL::to('admin/user/setting') }}" class="btn btn-primary btn-block">Setting</a>
        </div>
      </div>
    </div>
